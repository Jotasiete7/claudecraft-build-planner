  ...
  async function loadAndRenderMetaBuilds() {
    ...
    const formattedLocalBuilds = rawLocalBuilds.map(b => ({
      builds: {
        ...
        patch_version: b.patchVersion || null,
            ...
            ${data.map(item => {
              ...
              return `
                <tr class="border-b border-wurm-border/40 hover:bg-white/5 transition-all">
                  ...
                  <td class="p-3 font-mono text-[10px]"><span class="bg-amber-950/80 border border-amber-500/40 text-amber-300 px-1.5 py-0.5 rounded font-bold">${b.patch_version || '—'}</span></td>
