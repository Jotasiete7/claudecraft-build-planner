  ...
  paladin: {
    ...
    specs: [
      ...
      },
      {
        ...
        primaryStat: 'Strength',
        complexity: 'Low',
        passive: 'Oathward — Increases all threat generated by 1.3x multiplier, armor by 20%, and Oathward mastery block by 40%.',
        sampleSkills: [
  ...
  shaman: {
    ...
    specs: [
      ...
      },
      {
        ...
        primaryStat: 'Strength',
        complexity: 'High',
        passive: 'Warspirit Stonebound — Gains 20% Stamina, 40% Armor, 15% Damage Reduction, and 2.5x Threat Multiplier for heroic tanking.',
        sampleSkills: [
  ...
  druid: {
    ...
    specs: [
      ...
      },
      {
        ...
        primaryStat: 'Agility',
        complexity: 'High',
        passive: 'Primal Heart / Bruin Form — Increases max health by 30%, threat by 2.1x armor multiplier. Grants Savage Mending (180 HP heal / 60s) and Baleful Roar (10yd area taunt / 3s). Wolf Form paw speed fixed at 1.0s.',
        sampleSkills: [
          { name: 'Maul', iconUrl: getSkillIconUrl('druid', 'maul'), isSignature: true },
          { name: 'Savage Mending', iconUrl: getSkillIconUrl('druid', 'rejuvenation') },
          { name: 'Baleful Roar', iconUrl: getSkillIconUrl('druid', 'swipe') },
          { name: 'Feral Charge', iconUrl: getSkillIconUrl('druid', 'claw') }
        ]
      },
      {
        id: 'restoration',
